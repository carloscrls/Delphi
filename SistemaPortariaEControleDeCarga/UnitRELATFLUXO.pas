...
uses DM, unitRELATFLUXOdetalhado;
...
procedure TFRMRELATFLUXO.Button1Click(Sender: TObject);
begin
FRMRELATFLUXODETALHADO.ADOQueryFLUXO.close;
FRMRELATFLUXODETALHADO.ADOQueryFLUXO.SQL.Clear;
FRMRELATFLUXODETALHADO.ADOQueryFLUXO.SQL.add('SELECT colaborador.nome,fluxo.* FROM FLUXO,colaborador where  fluxo.cod_colab = colaborador.codigo');
FRMRELATFLUXODETALHADO.ADOQueryFLUXO.open;
FRMRELATFLUXODETALHADO.ADOQueryFLUXO.ExecSQL;
FRMRELATFLUXODETALHADO.ShowModal;
end;
