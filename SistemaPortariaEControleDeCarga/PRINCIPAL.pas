...
begin
  FRMRELATFLUXO.ADODataSet1.Close;
  FRMRELATFLUXO.ADODataSet1.CommandText:=('SELECT NOME,SIT,SITDATE,SITTIME,CARGO FROM COLABORADOR WHERE SITDATE IS NOT NULL AND SIT=''ENTRADA'' AND CARGO<>''MOTORISTA-DE-CAMINHAO''');
  FRMRELATFLUXO.ADODataSet1.open;
  FRMRELATFLUXO.DBGrid1.Refresh;
  FRMRELATFLUXO.ShowModal;
end;
