...
type
  TDMUNT = class(TDataModule)
    ...
    ADODSCONTROLEDEINTEGRACAONR_OPC1_DATA: TDateTimeField;
    ADODSCONTROLEDEINTEGRACAONR_OPC2_DATA: TDateTimeField;
    ADODSCONTROLEDEINTEGRACAONR_OPC3_DATA: TDateTimeField;
    ADODSCONTROLEDEINTEGRACAONR_OPC4_DATA: TDateTimeField;
    ADODSCONTROLEDEINTEGRACAONR_OPC5_DATA: TDateTimeField;
    ADODSCONTROLEDEINTEGRACAONR_OPC6_DATA: TDateTimeField;
    ADODSCONTROLEDEINTEGRACAOOBS: TMemoField;
    ADODSCARGADESCARGADATAENTRADA: TDateTimeField;
    ADODSCARGADESCARGAHORAENTRADA: TStringField;
    ADODSCARGADESCARGADATASAIDA: TDateTimeField;
    ADODSCARGADESCARGAHORASAIDA: TStringField;
    ADODSCONTROLEDEINTEGRACAOASO_DATA: TDateTimeField;
    ADODSCONTROLEDEINTEGRACAOVALIDADE_ASO_DATA: TDateTimeField;
    ...
    ADODSCOLABintegrado: TStringField;
    backup: TADOQuery;
  private
