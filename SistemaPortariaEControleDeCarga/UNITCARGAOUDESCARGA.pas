...
DBEdit22.Text:='SAIDA'; //DBEDIT INVISIVEL PARA INSERÇÃO
...
VAR PESOLIQUIDO,PESOENTRADA,PESOSAIDA :REAL;
    ...
    if DBEdit23.Text=VERIFICA then    //TESTE DE VERIFICAÇAO ENTRADA SAIDA
     begin
     ...
     else //FIM DO TESTE DE VERIFICAÇAO ENTRADA SAIDA
      ...
      and (DBEdit7.text<>'') and (DBedit9.text<>'')  THEN
       BEGIN
        ...
        BITBTNSAIDA.VISIBLE:=TRUE;
         ...
         begin
           ShowMessage('ERRO Nenhum campo pode estar vazio'+#13+'Campos de PESO ou Num da nota fiscal não podem estar vazios');
         end;
       end;
...
//lista somente pessoas e placas que estão fora
ADOMOTORISTA.SQL.Clear;
ADOMOTORISTA.active:=false;
...
DBEdit22.Text:='ENTRADA'; //DBEDIT INVISIVEL PARA INSERÇÃO
