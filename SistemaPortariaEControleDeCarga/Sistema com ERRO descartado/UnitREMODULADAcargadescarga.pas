...
if DBLookupComboBox2.Text<>'' then
 ...
 ELSE
 BEGIN
   SHOWMESSAGE('Primeiro e preciso atribuir entrada a algum caminhão');
 END;
...
if (DBEdit7.Text<>'') AND (DBEdit8.Text<>'') then
 ...
 ELSE
 BEGIN
   SHOWMESSAGE('É necessário atribuir peso entrada e peso saida antes de "Registrar saida"');
 END;
...
if DBEdit7.text<>'' then
 ...
 begin
   showmessage('Falta atribuir peso entrada a um caminhão'+#13+'Abrindo "Registrar Peso Entrada"');
   BitBtn2.Click;
